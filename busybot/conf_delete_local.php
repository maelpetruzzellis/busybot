...
<html>
	...
	<div class="header">
		...
		<p align="center">VOULEZ VOUS VRAIMENT SUPPRIMER CE LOCAL ?</p>
		<table align="center">
            <tr>
            ...
            <tr>
                ...
                <td><? echo $_GET['lieu'] ?></td>
            </tr>
		</table><br />
		
    <!--CONFIRMATION OUI / NON-->
    <p value="delete"><a href="req_suppression_local.php?id=<?= $_GET['id'] ?>">OUI</a><p/>
    <p value="noDelete"><a href="req_nosuppression_local.php?id=<?= $_GET['id'] ?>">NON</a><p/>
